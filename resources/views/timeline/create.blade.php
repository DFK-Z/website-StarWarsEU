    ...
    <form method="POST" action="{{ route('timeline.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input id="year" type="number" name="year" value="{{ old('year') }}" class="form-input" placeholder="Например: -32 (32 ДБЯ) или 5 (5 ПБЯ)" required>
            ...
            <div class="form-group">
                ...
                <select id="type" name="type" class="form-input" required>
                    ...
                    <option value="general" {{ old('type') == 'general' ? 'selected' : '' }}>🌟 Общее</option>
                </select>
